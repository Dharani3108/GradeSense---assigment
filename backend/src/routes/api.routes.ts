...
import { createAnnotationPlaceholder, createGradePlaceholder, createOcrPlaceholder, getHistoryPlaceholder, getReportPlaceholder } from '../controllers/workflow.controller.js'
...
apiRouter.post('/ocr', createOcrPlaceholder)
